...
class EcommerceSeleniumScraper(BaseSeleniumScraper):
    ...
    def validate_store_picked(self, store_name: str ) -> bool:
        ...
        if current_store:
            ...
            self.logger.error(
                f'(validate_store_picked) Failed at getting Store name value, Received: {current_store}' # noqa
            )
            return False
    ...
    def find_categories_data(
        ...
        if categories_elements_list:
            ...
            return self.prepare_categories_discovery_data(
                ...
                has_childs=categories_map[category_level]["has_childs"],
                has_products=categories_map[category_level]["has_products"], # noqa
            )
        else:
            self.logger.error(
    ...
    def find_products_data(
        ...
        - :arg category_level:
            ...
            Products to to Category by it's level.
        - :arg html_element: Lxml HtmlElement to process.
        """
        self.logger.info(
    ...
    def find_all_products_data(
        ...
        if products is not None:
            ...
            self.logger.error(
                f"(find_all_products_data) Returned: '{products}' Products at URL: {self.current_url} - Quiting." # noqa
            )
            pass
